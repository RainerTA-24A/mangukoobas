    ...
    <div className="app">
      ...
      <section className="games-section">
        ...
        {filteredGames.map(game => (
            /* Kasutame Link komponenti ümber kaardi */
            /* Kontrollime: Kui mäng on Tic-Tac-Toe, suuname /tictactoe, muidu /# */
            <Link 
            key={game.id} 
            to={game.title === 'Tic-Tac-Toe' ? '/tictactoe' : '#'} 
            className="game-card-link" 
            style={{ textDecoration: 'none', color: 'inherit' }} // Eemaldab lingi allkriipsu
            >
